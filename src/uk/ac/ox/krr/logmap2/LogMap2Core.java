...
public class LogMap2Core {
	...
	public LogMap2Core(
		...
		System.out.println("Number of computed mappings: " + getLogMapMappings().size());
		...
		if (evaluate_impact){
			...
			System.out.println("Time checking impact integration (s): " + (float)((double)fin-(double)init)/1000.0);
		}
	...
	public static void main(String[] args) {
		...
		} else if (ontopair == Utilities.GOBP2NCI) {
			uri2 = "file:///Users/safrant/EVS/data/Thesaurus/Biological_Process.owl";

			uri1 = "file:///Users/safrant/EVS/data/GO/go_extract_owl1.owl";

			gs_mappings = "";
			logmap_mappings = "/Users/safrant/EVS/data/GO/logmap_Output";

			uri1_out = "";
			uri2_out = "";
		} else if (ontopair == Utilities.NCI2GOBP) {
			uri1 = "file:///Users/safrant/EVS/data/Thesaurus/Biological_Process.owl";

			uri2 = "file:///Users/safrant/EVS/data/GO/go_extract_owl1.owl";

			gs_mappings = "";
			logmap_mappings = "/Users/safrant/EVS/data/NCI/logmap_Output";
